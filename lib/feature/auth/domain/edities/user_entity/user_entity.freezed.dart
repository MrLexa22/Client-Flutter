...
class _$_UserEntity implements _UserEntity {
  ...
  @override
  String toString() {
    return 'UserEntity(email: $email, username: $username, id: $id, access_token: $access_token, refresh_token: $refresh_token, userState: $userState, isDeleted: $isDeleted)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, email, username, id,
      access_token, refresh_token, userState, isDeleted);
...
abstract class _UserEntity implements UserEntity {
  const factory _UserEntity(
      ...
      final bool? isDeleted}) = _$_UserEntity;
